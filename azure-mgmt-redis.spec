...
Source0  : https://files.pythonhosted.org/packages/38/0c/1fae863867ab615c23fc62c1f1895aef20af432c79f9adf69b9a26139158/azure-mgmt-redis-12.0.0.zip
Summary  : Microsoft Azure Redis Cache Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-redis-python = %{version}-%{release}
Requires: azure-mgmt-redis-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-redis package.
Group: Default
Requires: azure-mgmt-redis-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-redis package.


%package python3
Summary: python3 components for the azure-mgmt-redis package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_redis)
Requires: pypi(azure_common)
Requires: pypi(azure_mgmt_core)
Requires: pypi(msrest)

%description python3
python3 components for the azure-mgmt-redis package.


%prep
%setup -q -n azure-mgmt-redis-12.0.0
cd %{_builddir}/azure-mgmt-redis-12.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608047457
